...
<div id="location_filterbar" class="filterbar mt-3" style="display: none;">
    ...
    <div id="country_option" class="mt-2" style="display:none ;">
        <ul class="list-group ">
            <?php
            $sql = "SELECT DISTINCT country FROM resort ORDER BY country";
...
<li class='list-group-item'>
    ...
    <div id="state_option" class="mt-2" style="display:none ;">
        <ul class="list-group ">
            <?php
            $sql = "SELECT DISTINCT state FROM resort ORDER BY state";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo "
<li class='list-group-item'>
    ...
    <div id="city_option" class="mt-2" style="display:none ;">
        <ul class="list-group ">
            <?php
            $sql = "SELECT DISTINCT city FROM resort ORDER BY city";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo "
<li class='list-group-item'>
...
<div id="title_filterbar" class="filterbar mt-3" style="display:none ;">
    <ul class="list-group">
        <?php
        $sql = "SELECT DISTINCT title FROM resort ORDER BY title";
        $result = mysqli_query($conn, $sql);
        while ($row = mysqli_fetch_assoc($result)) {
            echo "
<li class='list-group-item'>
...
<!-- =========================================================== -->
<!-- star rating filter starts -->

<div class="d-grid gap-2">
    <button id="open_star_rating" class="filterbtn btn" style="font-weight: bold;">Star Rating</button>
</div>

<div id="star_rating_filterbar" class="filterbar mt-3" style="display:none ;">
    <ul class="list-group">
        <?php
        $sql = "SELECT DISTINCT star_rating FROM resort ORDER BY star_rating";
        $result = mysqli_query($conn, $sql);
        while ($row = mysqli_fetch_assoc($result)) {
            echo "
<li class='list-group-item'>
...
<div id="hotel_type_filterbar" class="filterbar mt-3" style="display:none ;">
    <ul class="list-group">
        <?php
        $sql = "SELECT DISTINCT type_of_hotel FROM resort ORDER BY type_of_hotel";
        $result = mysqli_query($conn, $sql);
        while ($row = mysqli_fetch_assoc($result)) {
            echo "
<li class='list-group-item'>
...
<!-- number of rooms filter starts here  -->
...
<!-- ======================================================================================== -->
<!-- amenity filter start here  -->



<div class="d-grid gap-2">
    <button id="open_amenity" class="filterbtn btn">Amenity</button>
</div>

<div id="amenity_filterbar" class="filterbar mt-3" style="display: none;">

    <!-- ---------------------------------- -->
    <div class="d-grid gap-2">
        <button id="pool_list" class="btn filterbtn">Pool</button>
    </div>

    <div id="pool_option" class="mt-2" style="display:none ;">
        <ul class="list-group ">
            <?php
            $sql = "SELECT DISTINCT pool FROM resort ORDER BY pool";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo "
<li class='list-group-item'>
    <div class='form-check'>
        <label for='title' class='form-check-label'>
            <input type='checkbox' value='" . $row['pool'] . "' class='form-check-input filter_check' id='pool'>{$row['pool']} 
        </label>
    </div>
</li>";
            }  ?>
    ...
    <!-- ---------------------------------- -->
    <div class="d-grid gap-2">
        <button id="activities_list" class="btn filterbtn">Activities</button>
    </div>

    <div id="activities_option" class="mt-2" style="display:none ;">
        <ul class="list-group ">
            <?php
            $sql = "SELECT DISTINCT activities FROM resort ORDER BY activities";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo "
<li class='list-group-item'>
    <div class='form-check'>
        <label for='title' class='form-check-label'>
            <input type='checkbox' value='" . $row['activities'] . "' class='form-check-input filter_check' id='activities'>{$row['activities']} 
        </label>
    </div>
</li>";
            }  ?>
    ...
    <!-- ---------------------------------- -->
    <div class="d-grid gap-2">
        <button id="bar_list" class="btn filterbtn">Bar</button>
    </div>

    <div id="bar_option" class="mt-2" style="display:none ;">
        <ul class="list-group ">
            <?php
            $sql = "SELECT DISTINCT bar FROM resort ORDER BY bar";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo "
<li class='list-group-item'>
    <div class='form-check'>
        <label for='title' class='form-check-label'>
            <input type='checkbox' value='" . $row['bar'] . "' class='form-check-input filter_check' id='bar'>{$row['bar']} 
        </label>
    </div>
</li>";
            }  ?>
    ...
    <!-- ---------------------------------- -->
    <div class="d-grid gap-2">
        <button id="golf_course_list" class="btn filterbtn">Golf Course</button>
    </div>

    <div id="golf_course_option" class="mt-2" style="display:none ;">
        <ul class="list-group ">
            <?php
            $sql = "SELECT DISTINCT golf_course FROM resort ORDER BY golf_course";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo "
<li class='list-group-item'>
    <div class='form-check'>
        <label for='title' class='form-check-label'>
            <input type='checkbox' value='" . $row['golf_course'] . "' class='form-check-input filter_check' id='golf_course'>{$row['golf_course']} 
        </label>
    </div>
</li>";
            }  ?>
    ...
    <!-- ---------------------------------- -->
    <div class="d-grid gap-2">
        <button id="gym_list" class="btn filterbtn">Gym</button>
    </div>

    <div id="gym_option" class="mt-2" style="display:none ;">
        <ul class="list-group ">
            <?php
            $sql = "SELECT DISTINCT gym FROM resort ORDER BY gym";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo "
<li class='list-group-item'>
    <div class='form-check'>
        <label for='title' class='form-check-label'>
            <input type='checkbox' value='" . $row['gym'] . "' class='form-check-input filter_check' id='gym'>{$row['gym']} 
        </label>
    </div>
</li>";
            }  ?>
    ...
    <!-- ---------------------------------- -->
    <div class="d-grid gap-2">
        <button id="spa_list" class="btn filterbtn">Spa</button>
    </div>

    <div id="spa_option" class="mt-2" style="display:none ;">
        <ul class="list-group ">
            <?php
            $sql = "SELECT DISTINCT spa FROM resort ORDER BY spa";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo "
<li class='list-group-item'>
    <div class='form-check'>
        <label for='title' class='form-check-label'>
            <input type='checkbox' value='" . $row['spa'] . "' class='form-check-input filter_check' id='spa'>{$row['spa']} 
        </label>
    </div>
</li>";
            }  ?>
...
<div id="technology_filterbar" class="filterbar mt-3" style="display: none;">
    ...
    <div id="hrms_option" class="mt-2" style="display:none ;">
        <ul class="list-group ">
            <?php
            $sql = "SELECT DISTINCT hrms FROM resort ORDER BY hrms";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo "
<li class='list-group-item'>
    ...
    <div id="ats_option" class="mt-2" style="display:none ;">
        <ul class="list-group ">
            <?php
            $sql = "SELECT DISTINCT ats FROM resort ORDER BY ats";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo "
<li class='list-group-item'>
...
<div class="d-grid gap-2">
    <a href="resort.php" id="clear_filter" class=" btn" style="font-weight: bold;font-style:italic;color:blue">Clear Filters</a>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $(".filter_check").click(function() {
            ...
            var pool = get_filter_text('pool');
            var activities = get_filter_text('activities');
            var bar = get_filter_text('bar');
            var golf_course = get_filter_text('golf_course');
            var gym = get_filter_text('gym');
            var spa = get_filter_text('spa');
