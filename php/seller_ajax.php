...
if (isset($_POST['action'])) {
    $sql = "SELECT * FROM seller WHERE company_name !='' ";
    ...
    if (isset($_POST['selling_platform'])) {
        $selling_platform = implode("','", $_POST['selling_platform']);
        $sql .= "AND selling_platform IN('" . $selling_platform . "')";
    }
