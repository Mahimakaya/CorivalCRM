...
if (isset($_POST['action'])) {
    $sql = "SELECT * FROM dmc_business_travel_agency WHERE company_name !='' ";
    ...
    $from = $_POST['from'];
    $sql .= "AND no_of_property >= ".$from." ";

    $to = $_POST['to'];
    $sql .= "AND no_of_property <= ".$to." ";
...
if (isset($_POST['dlt_action'])) {
    $id = $_POST['data_id'];
    $sql2 = "DELETE FROM dmc_business_travel_agency WHERE data_id = {$id} ";
  ...
  if (isset($_POST['formfill'])) {
    $eid = $_POST['eid'];
    $sql3 = "SELECT * FROM dmc_business_travel_agency WHERE data_id = {$eid}";
