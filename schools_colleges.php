...
<?php include "php/schools_colleges_ajax.php"; ?>
...
<head>
    ...
    <!-- schools_colleges filter -->
    <link rel="stylesheet" href="css/schools_colleges_filter.css">
    <script src="js/schools_colleges_filter.js"></script>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-3">
                ...
                include "includes/schools_colleges_filter.php";
                ?>
            ...
            <div class="col-sm-9">
                ...
                <table id="myTable" class="table table-striped table-bordered">
                    ...
                    <tbody id="result">
                        ...
                        <?php
                        $sql = "SELECT * FROM `schools_colleges`";
