...
<?php include "php/ota_travel_agency_ajax.php"; ?>
...
<head>
    ...
    <!-- ota_travel_agency filter -->
    <link rel="stylesheet" href="css/ota_travel_agency_filter.css">
    <script src="js/ota_travel_agency_filter.js"></script>

    <!-- Insert form CSS -->
    <link rel="stylesheet" href="css/insert_form.css">

    <title> OTA and Travel Agency </title>
</head>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-3">
                ...
                include "includes/ota_travel_agency_filter.php";
                ?>

            </div>
            <div class="col-sm-9">

                <h4 class="m-3">Industry : Travel/OTA Travel Agency</h4>
                ...
                <table id="myTable" class="table table-striped table-bordered">
                    ...
                    <tbody id="result">
                        ...
                        <?php
                        $sql = "SELECT * FROM `ota_travel_agency`";
        ...
        <div id="insert-modal">
            <div id="insert-modal-form">
                ...
                <table id="insert-form" cellpadding="2px" width="100%">
                    <form action="php/ota_travel_agency_ajax.php" method="post">
                        <tr>
                            <td>Technology:</td>
