...
<?php include "php/crm_users_ajax.php"; ?>
...
<head>
    ...
    <!-- crm_users filter -->
    <link rel="stylesheet" href="css/crm_users_filter.css">
    <script src="js/crm_users_filter.js"></script>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-3">
                ...
                include "includes/crm_users_filter.php";
                ?>
