...
<?php include "php/dmc_business_travel_agency_ajax.php"; ?>
...
<head>
    ...
    <!-- dmc_business_travel_agency filter -->
    <link rel="stylesheet" href="css/dmc_business_travel_agency_filter.css">
    <script src="js/dmc_business_travel_agency_filter.js"></script>

    <!-- Insert form CSS -->
    <link rel="stylesheet" href="css/insert_form.css">

    <title> DMC , Business Travel Agency </title>
</head>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-3">
                ...
                include "includes/dmc_business_travel_agency_filter.php";
                ?>
            ...
            <div class="col-sm-9">
                ...
                <table id="myTable" class="table table-striped table-bordered">
                    ...
                    <h4 class="m-3">Industry : Travel/DMC Business Travel Agency</h4>
                    ...
                    <tbody id="result">
                        ...
                        <?php
                        $sql = "SELECT * FROM `dmc_business_travel_agency`";
        ...
        <div id="insert-modal">
            <div id="insert-modal-form">
                <h4 class="text-center">Insert New Data into OTA Travel Agency</h4>
                <hr>

                <table id="insert-form" cellpadding="2px" width="100%">
                    <form action="php/dmc_business_travel_agency_ajax.php" method="post">
                        <tr>
                            <td>Technology:</td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", ".delete-btn", function(e) {
                ...
                if (conf == true) {
                    $.ajax({
                        url: "php/dmc_business_travel_agency_ajax.php",
                        type: "POST",
                        data: {
                            data_id: data_id,
            ...
            $(document).on("click", "#update-submit", function(e) {
                ...
                var properties = $("#update-no_of_property").val();
